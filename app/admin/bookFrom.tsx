...
export default function Createbook() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Éxito', 'Libro agregado al inventario', [
        {
          text: 'OK',
          onPress: () => {
            resetForm();
  ...
  return (
    <View style={styles.contentContainer}>
      ...
      <ScrollView
        ...
        contentContainerStyle={[styles.container, styles.content, { paddingBottom: 100 }]}
          ...
          <View style={styles.form}>
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputWrapper}>
                ...
                <TextInput
                  style={styles.input}
                  placeholder="e.j. La sombra del viento"
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputWrapper}>
                ...
                <TextInput
                  style={styles.input}
                  placeholder="e.j. Carlos Ruiz Zafón"
                  placeholderTextColor="#94a3b8"
                  value={form.author}
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputWrapper}>
                ...
                <TextInput
                  style={styles.input}
                  placeholder="Escribe un resumen convincente..."
                  placeholderTextColor="#94a3b8"
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputWrapper}>
                ...
                <TouchableOpacity style={styles.iconRight} onPress={handleAddTag}>
