    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.titlePrin}>
          ...
          <Text style={styles.titlePrinWord}>lectura</Text>
        </Text>

        <Text style={styles.descriptionPrin}>
          ¿No sabes qué leer hoy? Haz match con tu próximo libro respondiendo
          preguntas simples sobre tu estado de ánimo y preferencias.
      ...
      <View style={styles.sectionHow}>
        ...
        <Text style={styles.sectionHowTitle}>
          CÓMO FUNCIONA?
        </Text>

        <View style={styles.cardHow}>
          <View style={styles.containerIconsHow}>
            <MaterialIcons
          ...
          <Text style={styles.numberHow}>
            1. Haz el quiz
          </Text>

          <Text style={styles.descriptionHow}>
            Cuéntanos cuáles son tus géneros, tropos y preferencias
            de lectura favoritos en un rápido cuestionario de 1 minuto.
          </Text>
        </View>
        ...
        <View style={styles.cardHow}>
          ...
          <Text style={styles.descriptionHow}>
            Explora un feed personalizado de libros para ti.
            Desliza hacia la derecha para guardarlo en tu biblioteca,
            hacia la izquierda para omitirlo por ahora.
          </Text>
        </View>
        ...
        <View style={styles.cardHow}>
          ...
          <Text style={styles.numberHow}>
            3. Crea tu lista de libros pendientes
          </Text>

          <Text style={styles.descriptionHow}>
            Guarda los libros que quieres leer en tu lista de pendientes.
            Puedes marcarlos como leídos cuando los termines de leer.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.containerRegister}>
        <Text style={styles.containerRegisterTitle}>
          ¿Listo para conocer a tu próximo autor favorito?
        </Text>

        <Text style={styles.containerRegisterDescription}>
          Únete a más de 50.000 amantes de los libros que encuentran
          cada día sus autores perfectos.
        </Text>

        <Link href="/auth/register" asChild>
          <TouchableOpacity style={styles.btnPrin}>
            <Text style={styles.btnPrinTxt}>
              Registrate
            </Text>
          </TouchableOpacity>
        </Link>
